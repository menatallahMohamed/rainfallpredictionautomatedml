...
automl_run_id = 'AutoML_1c63b520-d391-45aa-9a7d-dce6145117ba_34'
...
def generate_data_transformation_config():
    ...
    column_group_4 = [['Rainfall'], ['Evaporation'], ['Sunshine'], ['WindGustSpeed'], ['WindSpeed3pm'], ['Humidity9am'], ['Humidity3pm'], ['Pressure9am'], ['Pressure3pm'], ['Cloud9am'], ['Cloud3pm'], ['Temp3pm']]
    
    column_group_3 = [['MinTemp'], ['MaxTemp'], ['Rainfall'], ['Evaporation'], ['Sunshine'], ['WindGustSpeed'], ['WindSpeed9am'], ['WindSpeed3pm'], ['Humidity9am'], ['Humidity3pm'], ['Pressure9am'], ['Pressure3pm'], ['Cloud9am'], ['Cloud3pm'], ['Temp9am'], ['Temp3pm']]
    
    column_group_2 = ['RainToday']
    
    column_group_1 = ['Location', 'WindGustDir', 'WindDir9am', 'WindDir3pm']
...
def generate_algorithm_config():
    ...
    algorithm = PreFittedSoftVotingClassifier(
        ...
        weights=[0.4, 0.2, 0.06666666666666667, 0.06666666666666667, 0.06666666666666667, 0.06666666666666667, 0.06666666666666667, 0.06666666666666667]
    )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_dataset_id', type=str, default='8daf1258-611a-405b-bedf-f8311eaadae4',     help='Default training dataset id is populated from the parent run')
